...
class PDFViewer(QMainWindow):
    ...
    def update_page_content(self, page_number, pixmap):
        ...
        if 0 <= page_number < len(self.page_widgets):
            ...
            # After rendering this page, remove it from the rendering list and process the next
            self.rendering_in_progress.remove(page_number)
            self.process_render_queue()  # Only process the next page after this one is done
